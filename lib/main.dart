        ...
        body: Column(
          ...
          children: [
            ...
            CircleAvatar(radius: 90,
              ...
              child: CircleAvatar(radius: 88.5,
              ...
              child: Container(
                ...
                child: Row(
                  children: [Padding(
                    ...
                    child: Icon(Icons.phone,size: 28,color: Color(0xff6F3D18),),
                  ),
                  Spacer(flex: 1,),

                   Text("(+20) 01027462660",style: TextStyle(fontSize: 18),),
                  Spacer(flex: 5,)
                  ],
                ),
              ),
            ...
            Padding(
              ...
              child: Container(
                ...
                child: Row(
                  children: [Padding(
                    padding: const EdgeInsets.all(14.0),
                    child: Icon(Icons.mail,size: 28,color: Color(0xff6F3D18),),
                  ),
                  Spacer(flex: 1,),

                   Text("zalmahamdy974@gmail.com",style: TextStyle(fontSize: 18),),
                  Spacer(flex: 3,)
                  ],
                ),
              ),
